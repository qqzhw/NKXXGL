...
namespace ICIMS.Core.Common
{
    ...
    public class UtilsHelper
    {
		...
		private static char[] constant =
       {
        ...
        {
            string path = string.Format("pack://application:,,,/ICIMS.Core.Resources;component/{0}", imgPath);
		...
		{
			string path = string.Format("pack://application:,,,/ICIMS.Core.Resources;component/Images/{0}", imgPath);
