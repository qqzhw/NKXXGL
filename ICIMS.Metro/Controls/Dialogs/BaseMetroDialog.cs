...
namespace ICIMS.Metro.Controls.Dialogs
{
    /// <summary>
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        /// <summary>
        /// Initializes a new ICIMS.Metro.Controls.BaseMetroDialog.
        /// </summary>
        ...
        private static object TryGetResource(ICIMS.Metro.Theme theme, string key)
        {
            if (theme == null)
            {
        ...
        private static ICIMS.Metro.Theme DetectTheme(BaseMetroDialog dialog)
        {
            if (dialog == null)
            {
                return null;
