...
namespace ICIMS.Service.BaseData
{
    public class ItemCategoryService: IItemCategoryService
    {
        ...
        private string _baseUrl = "api/services/app/ItemCategory/GetPaged";
        public ItemCategoryService(IWebApiClient webApiClient)
        {
            this._webApiClient = webApiClient;
        }
        public async Task<List<ItemCategoryItem>> GetPaged()
        {
            ...
            var data = await _webApiClient.GetAsync<ResultData<List<ItemCategoryItem>>>($"{_webApiClient.BaseUrl}{_baseUrl}", para);
